...
router.get('/', cache('2 minutes'), apiRequestLimiter, function(req, res) {
    ...
    axios({
        ...
        var livescore = ({
            ...
            batsman: batsman || "Match Ended",
            batsmanrun: batsmanrun || "Match Ended",
            ballsfaced: ballsfaced || "Match Ended",
            fours: fours || "Match Ended",
            sixes: sixes || "Match Ended",
            sr: sr || "Match Ended",
            batsmantwo: batsmantwo || "Match Ended",
            batsmantworun: batsmantworun || "Match Ended",
            batsmantwoballsfaced: batsmantwoballsfaced || "Match Ended",
            ...
            bowler: bowler || "Match Ended",
            bowlerover: bowlerover || "Match Ended",
            bowlerruns: bowlerruns || "Match Ended",
            bowlerwickets: bowlerwickets || "Match Ended",
